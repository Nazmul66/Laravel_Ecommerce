...
@section('title')
   <title>Ecommerce | All products page</title>
@endsection
                     ...
                     <div class="row margin-res">
                        ...
                        @if ($products->count() == 0)
                            <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show mt-3">
                                <div class="text-white text-center">Oops! there is no product data here.</div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        @if ( !is_null($product->offer_price) )
                                            <div class="price-table">
                                                <h3>৳{{ $product->offer_price }} BDT</h3>
                                                <h6><del>৳{{ $product->regular_price }} BDT</del></h6>
                                            </div>
                                        @else
