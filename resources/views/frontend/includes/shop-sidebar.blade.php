        ...
        <div class="collection-collapse-block open">
            ...
            <div class="collection-collapse-block-content">
                <div class="collection-brand-filter">
                    ...
                    @foreach ( App\Models\Category::orderBy('name', 'asc')->where('status', 1)->get() as $category )
                      ...
                      @foreach ( App\Models\SubCategory::orderBy('name', 'asc')->where('category_id', $category->id)->where('status', 1)->get() as $subCat )

                        <p>
                            <a href="{{ route('category.product', $subCat->slug) }}">
                                {{ $subCat->name }}
                            </a>
                        </p>
